...
const RULES = {
  ...
  Computers: {
    type: opt(
      ...
      [/kjøler|vannkjøling|kjølepasta|thermal paste|cpu-vifte|kabinettvifte|viftekontroller/, 'Cooling'],
      ...
      [/kabinett/, 'Cases'],
      [/lydkort/, 'Sound cards'],
      [/nettverkskort|nettverksadapter|wi-?fi.?adapter/, 'Network adapters'],
      [/blu-?ray-?(brenner|stasjon)|dvd-?brenner|cd-?brenner|optisk stasjon/, 'Optical drives'],
      [/\bups\b|avbruddsfri/, 'UPS'],
  ...
  Garden: {
    type: opt(
      ...
      [/\bplante\b|blomst|\bkrukke\b|\bpotte\b|\bjord\b|frø(?![\wæøå])|gjødsel|plantekasse/, 'Plants & pots'],
      [/\bgrill\b|gassgrill|kullgrill|briketter/, 'Grills'],
      [/\bslange\b|vanning|vannkanne|spreder/, 'Watering'],
      [/\bspade\b|\brake\b|hagesaks|(?<![\wæøå])øks(?![\wæøå])|\bsag\b|hageredskap|\bfiskars\b/, 'Garden tools'],
  ...
  Outdoor: {
    type: opt(
      ...
      [/\bkniv\b|(?<![\wæøå])øks(?![\wæøå])|\bhodelykt\b|kokeapparat|\btermos\b|\bstormkjøkken\b|\bkompass\b|\blighter\b/, 'Camping gear'],
  ...
  Jewelry: {
    type: opt(
      [/øredobb|ørepynt|øreringer?|earring/, 'Earrings'],
  ...
  Pets: {
    ...
    type: opt(
      ...
      [/kattesand|\bstrø(?![\wæøå])|bleier|kattedo|avfallspose/, 'Litter & hygiene'],
